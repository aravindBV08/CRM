...
if (document.querySelector("#grossVolume")) {
    ...
    const chart = new ApexCharts(document.querySelector("#grossVolume"), options);
    chart.render();

    // Theme color update
    document.addEventListener("theme_color", () => {
        const variableColors = IQUtils.getVariableColor();
        const colors = [variableColors.primary, variableColors.info];
        const newOpt = {
            colors: colors,
...
if (document.querySelector("#dashboard-line-chart")) {
    const variableColors = IQUtils.getVariableColor();
